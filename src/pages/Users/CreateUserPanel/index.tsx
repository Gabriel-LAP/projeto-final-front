...
const CreateUserPanelContainer = styled.div`
  display: 'flex';
...
const CreateUserPanel = ({ openCreateUserPanel }) => {
  ...
  const handleCreateUser = async () => {
    ...
    openCreateUserPanel(false);
    return await createUser(newUser);
  };
  return (
    <CreateUserPanelContainer>
      <Container
        display='flex'
        width='50rem'
      ...
      >
        ...
        <Button
          type='button'
          onClick={() => openCreateUserPanel(false)}
          text='Fechar'
          width='200px'
          height='40px'
          backgroundcolor={colors.purple}
